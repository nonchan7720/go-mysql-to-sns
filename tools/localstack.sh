...
awslocal sns create-topic --name test-sns.fifo --attributes FifoTopic=true
awslocal sqs create-queue --queue-name test-sns-dlq.fifo --attributes FifoQueue=true
